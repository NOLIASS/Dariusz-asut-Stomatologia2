      ...
      <div className="wrap contact-grid">
        <div className="contact-info">
          ...
          <div className="contact-details">
            <p><strong>Adres:</strong><a href="https://www.google.com/maps/search/?api=1&query=ul.+Macedo%C5%84ska+3%2C+51-113+Wroc%C5%82aw"
              target="_blank"
              rel="noopener noreferrer"> ul. Macedońska 3, 51-113 Wrocław</a> </p>
